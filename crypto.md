...
Выделяют *классические* Стейблкоин или *алгоритмические* стейблкоины.
...
- доступны через web-интерфейс и/или мобильное приложение 24x7x365,
...
- Binance: [обещали](https://www.binance.com/en/blog/leadership/ukraine-russia-sanctions-and-crypto-421499824684903532) и делают только блокировку пользователей из санкционных списков OFAC (вне зависимости от страны резидентства). 
...
Впереди долгая работа по составлению и поддержке чуть более длинных списков приложений для некастодиальных кошельков, поиск способов покупки аппаратных кошельков, отслеживание прецендентов, связанных с блокировками на централизованных биржах.
